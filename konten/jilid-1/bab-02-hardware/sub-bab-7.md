...
Tabel berikut membandingkan 16 platform untuk model Llama-3.1-8B Q4_K_M — dari kartu entry-level hingga server 8 GPU — dengan metrik TPJ dan estimasi biaya listrik bulanan.
...
Perlu kejujuran visual: pie chart ini menormalkan nilai ke dalam proporsi relatif, sehingga ukuran irisan tidak bisa dibaca sebagai "kali lipat" langsung (M4 Max 156 versus RTX 4090 40 berarti 3,9x, persis rasio TPJ aslinya). Yang hilang dari gambar ini adalah poros biaya: irisan M4 Max memang paling besar, tetapi harganya ~Rp 55 juta — dan karena itu diagram ini harus selalu dibaca bersama Tabel 1, di mana efisiensi dan harga bertemu. Pola yang pantas direnungkan: platform termahal sekaligus paling efisien (M4 Max) dan platform termurah relatif (RTX 3090 bekas) sama-sama rasional — keduanya hanya melayani profil pengguna yang berbeda, seperti yang akan diperlihatkan studi kasus.
...
[5] Zhang, H., et al. (2025). *TokenPowerBench: Benchmarking the Power Consumption of LLM Inference*. arXiv:2512.03024. DOI: [10.48550/arXiv.2512.03024](https://arxiv.org/abs/2512.03024)
